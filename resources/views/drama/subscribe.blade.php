        ...
        <div class="container mt-5">
            ...
            <div class="parent-container">
                <div class="container1">
                    <form action="{{ route('drama.subscribe.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>Subscribe for new upcoming drama news by entering your email here</label>
