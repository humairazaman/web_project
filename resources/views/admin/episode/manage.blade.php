                        ...
                        <div class="card-container">
                            <div class="card-body ">
                                ...
                                <button type="button" class="btn btn-success">
                                    <a href="{{ route('episode.create', ['drama' => $drama->id]) }}"
                            ...
                            <tbody>
                                @foreach ($drama->episodes as $episode)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('episode.edit', ['episode' => $episode->id, 'drama' => $drama->id]) }}"
                                                class="btn btn-primary">Edit</a>
                                            <form
                                                action="{{ route('episode.destroy', ['episode' => $episode->id, 'drama' => $drama->id]) }}"
